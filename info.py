...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002563875182 -1002332123168 -1002231378642').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002563875182 -1002332123168 -1002231378642').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/FilmCity_Request')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Arpitbotmovies')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/FilmCity_Request')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'https://public-phylis-appi00-39073298.koyeb.app/'))
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
URL = "https://traditional-alvina-gavla-76ca3567.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else "https://public-phylis-appi00-39073298.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://public-phylis-appi00-39073298.koyeb.app/".format(FQDN)
else:
    URL = "https://public-phylis-appi00-39073298.koyeb.app/".format(FQDN)
